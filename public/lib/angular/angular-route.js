...
(function(window, angular, undefined) {'use strict';
    ...
    function $RouteProvider(){
         ...
         *    Object properties:
         *
         *    - `controller` 鈥� `{(string|function()=}` 鈥� Controller fn that should be associated with newly
         ...
         *      returns an html template as a string which should be used by {@linkngRoute.directive:ngView ngView} or {@link ng.directive:ngInclude ngInclude} directives.
